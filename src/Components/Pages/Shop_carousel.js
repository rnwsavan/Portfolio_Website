            ...
            <div id="main-wrapper">
                <div className="site-wrapper-reveal border-bottom">
                    ...
                    <div className="product-wrapper section-space--ptb_120">
                        <div className="container">
                            {/* Product Area Start */}
                            <div className="product-wrapper section-space--pb_90">
                                <div className="row align-items-center">
                                    <div className="col-lg-3 col-md-4">
                                        <div className="section-title text-md-start text-center tablet-mt__20 small-mt__20">
                                            <h3 className="section-title">Trending items</h3>
                                        </div>
                                    </div>
                                    <div className="col-lg-9 col-md-8">
                                        <ul className="nav product-tab-menu  justify-content-center justify-content-md-end" role="tablist">
                                            <li className="tab__item nav-item active">
                                                <a className="nav-link active" data-bs-toggle="tab" href="#tab_list_01" role="tab">All Products</a>
                                            </li>
                                            <li className="tab__item nav-item">
                                                <a className="nav-link" data-bs-toggle="tab" href="#tab_list_02" role="tab">Accessories</a>
                                            </li>
                                            <li className="tab__item nav-item">
                                                <a className="nav-link" data-bs-toggle="tab" href="#tab_list_03" role="tab">Chair</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div className="tab-content">
                                    <div className="tab-pane fade show active" id="tab_list_01">
                                                ...
                                                <div className="single-product-item text-center">
                                                    <div className="products-images">
                                                        ...
                                                        <div className="product-actions">
                                                            ...
                                                            {/* <a href="product-details.html"><i className="p-icon icon-bag2" /> <span className="tool-tip">Add to cart</span></a> */}
                                                            <NavLink exact to={"/product_detail"}><i className="p-icon icon-bag2" /> <span className="tool-tip">Add to cart</span></NavLink>
                                                            {/* <a href="wishlist.html"><i className="p-ico     n icon-heart" /> <span className="tool-tip">Browse Wishlist</span></a> 
                                                            */}
                                                            <NavLink exact to={"/whishlist"}><i className="p-icon icon-heart" /> <span className="tool-tip">Browse Wishlist</span></NavLink>
                                                        </div>
                                                    </div>
                                                    <div className="product-content">
                                                        <h6 className="prodect-title"><a href="product-details.html">Wooden Flowerpot</a></h6>
                                                        <div className="prodect-price">
                                                            <span className="new-price">£40.00</span> - <span className="old-price"> £635.00</span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="tab-pane" id="tab_list_02">
                                        <div className="product-slider-active">
                                            <div className="col-lg-12">
                                                {/* Single Product Item Start */}
                                                <div className="single-product-item text-center">
                                    ...
                                    <div className="tab-pane fade" id="tab_list_03">
                                        {/* product-slider-active */}
                                        <div className="product-slider-active">
                                            <div className="col-lg-12">
                                                {/* Single Product Item Start */}
                                                ...
                                                <div className="single-product-item text-center">
                                                    <div className="products-images">
                                                        ...
                                                        <div className="product-actions">
                                                            ...
                                                            {/* <a href="product-details.html"><i className="p-icon icon-bag2" /> <span className="tool-tip">Add to cart</span></a> */}
                                                            <NavLink exact to={"/product_detail"}><i className="p-icon icon-bag2" /> <span className="tool-tip">Add to cart</span></NavLink>
                                                            {/* <a href="wishlist.html"><i className="p-ico     n icon-heart" /> <span className="tool-tip">Browse Wishlist</span></a> */}<NavLink exact to={"/whishlist"}><i className="p-icon icon-heart" /> <span className="tool-tip">Browse Wishlist</span></NavLink>
                                                        </div>
                                                    </div>
                                                    <div className="product-content">
                                                        <h6 className="prodect-title">
                                        ...
                                        <div className="shop-toolbar__items-wrapper">
                                            <div className="shop-toolbar__item">
                                                <ul className="nav toolber-tab-menu justify-content-start" role="tablist">
                                                    ...
                                                    <li className="tab__item nav-item">
                                                        <a className="nav-link active" data-bs-toggle="tab" href="#tab_columns_02" role="tab"><img src="assets/images/svg/column-04.svg" className="img-fluid" alt="Columns 03" /> </a>
                                                    </li>
                                                    <li className="tab__item nav-item">
                                                        <a className="nav-link" data-bs-toggle="tab" href="#tab_columns_03" role="tab"><img src="assets/images/svg/column-05.svg" className="img-fluid" alt="Columns 03" /> </a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-4 col-md-4 col-sm-6">
                                            ...
                                            <div className="single-product-item text-center">
                                                ...
                                                <div className="product-content">
                                                    <h6 className="prodect-title"><a href="product-details.html">Simple Chair</a></h6>
                                                    <div className="prodect-price">
                                                        <span className="new-price">£70.00</span> - <span className="old-price"> £95.00</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-4 col-sm-6">
                                            ...
                                            <div className="single-product-item text-center">
                                                ...
                                                <div className="product-content">
                                                    <h6 className="prodect-title"><a href="product-details.html">Living room &amp; Bedroom lights</a></h6>
                                                    <div className="prodect-price">
                                                        <span className="new-price">£60.00</span> - <span className="old-price"> £69.00</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-4 col-sm-6">
                                            ...
                                            <div className="single-product-item text-center">
                                                ...
                                                <div className="product-content">
                                                    <h6 className="prodect-title"><a href="product-details.html">Gray lamp</a></h6>
                                                    <div className="prodect-price">
                                                        <span className="new-price">£80.00</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-4 col-sm-6">
                                            ...
                                            <div className="single-product-item text-center">
                                                ...
                                                <div className="product-content">
                                                    <h6 className="prodect-title"><a href="product-details.html">Decoration wood</a></h6>
                                                    <div className="prodect-price">
                                                        <span className="new-price">£50.00</span>
                                                    </div>
                                                </div>
