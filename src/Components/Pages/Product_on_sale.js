...
function Product_on_sale(props) {
    return (
        <div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div className="product-details-content">
                                            ...
                                            <div className="on-sale-price"><span className="new-price">£59.99</span><span className="old-price">£ 80.00</span> </div>
...
export default Product_on_sale;