                                        ...
                                        <div className="single-blog-item">
                                            <div className="blog-thumbnail-box">
                                                <a href="#" className="thumbnail">
                                                    <img src="assets/images/blog/8-1170x672.webp" className="img-fluid" alt="Blog Images" />
                                                </a>
                                            </div>
                                            <div className="blog-contents">
                                                <h3 className="blog-title-lg"><a href="#">Interior design is the art, the interior designer is the artist.</a></h3>
                                                <div className="row">
                                                    <div className="col-lg-9 m-auto">
                                                        ...
                                                        <blockquote>
                                                            <p> Dalena dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore etyt dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi utino aliquip ex ea commodo consequat.</p>
                                                        </blockquote>
                                                    </div>
                                                </div>
                                                <div className="row">
                                                    <div className="col-lg-6">
                                                        <div className="images mb-30">
                                                            <img src="assets/images/blog/01-lg-570x327.webp" className="img-fluid" alt />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6">
                                                        <div className="images mb-30">
                                                            <img src="assets/images/blog/02-lg-570x327.webp" className="img-fluid" alt />
                                                        </div>
                                                    </div>
                                                </div>
                                                <p className="mt-20 m-auto d_text">In show dull give need so held. One order all scale sense her gay style wrote. Incommode our not one ourselves residen. Shall there whose those stand she end. So unaffected partiality indulgence dispatched to of ebrated remarkably. Unfeel are had allowance own perceived abilities. Promotion an ourselves up other my. High what each snug rich far yet easy. In companions inhabiting mr principles at insensible do. Heard their hoped enjoy vexed child for. Prosperous so occasi assistance it discovered especially no. Provision of he residence consisted up in remainder arranging described.</p>
                                                <div className="row align-items-center">
                                                    <div className="col-lg-6">
                                                        <div className="blog-post-social-networks mt-20">
                                                            <h6 className="title">Share this story on :</h6>
                                                            <ul className="list">
                                                                <li className="item">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <div className="tag-blog d-flex justify-content-lg-end justify-content-start mt-20">
                                                            <h6 className="mr-2">Tags:</h6>
                                                            <div className="tagcloud"><a href="#" className="selected">Chair</a><a href="#">chair</a><a href="#">Table</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="post-author-box clearfix section-space--mt_60">
                                                    <div className="post-author-avatar">
                                                        <img src="assets/images/blog/author.webp" alt className="photo" />
                                                    </div>
                                                    <div className="post-author-info">
                                                        <h6 className="author-name">grixbase</h6>
                                                        <p className="mt-1">Caleigh Jerde is a writer and producer for TIME Healthland. She is a graduate from the Northwestern University Medill School of Journalism.</p>
                                                        <ul className="author-socials">
                                                            <li><a href="http://facebook.com/meditex" target="_blank">Facebook</a></li>
                                                            <li><a href="http://twitter.com/meditex" target="_blank">Twitter</a></li>
                                                            <li><a href="#" target="_blank">Pinterest</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div className="blog-relatel-post section-space--mt_60">
                                                    <div className="navigation post-navigation">
                                                        <a href="#" className="nav-links">
                                                            <i className="icon-chevron-left" /><span className="blog-nav nav-previous"><span className="d-text">Top 10 unique deco products 2022</span> <br /><span className="title-nav">Previous</span></span>
                                                        </a>
                                                        <a href="#" className="nav-links post-next">
                                                            <span className="blog-nav nav-next"><span className="d-text">Top 10 unique deco products 2022</span> <br /><span className="title-nav">Next</span></span>
                                                            <i className="icon-chevron-right" />
                                                        </a>
                                                    </div>
                                                </div>
                                                <div className="comments-area comments-reply-area section-space--mt_60">
                                                    <div className="row">
                                                        <div className="col-lg-9 m-auto">
                                                            <h4 className="mb-30">Leave a Reply</h4>
                                                            <form action="#" className="comment-form-area">
                                                                <div className="comment-input-12">
                                                                ...
                                                                <div className="comment-form-submit">
                                                                    <input type="submit" defaultValue="Post Comment" className="comment-submit btn--md" />
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
