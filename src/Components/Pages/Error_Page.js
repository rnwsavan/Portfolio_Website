                            ...
                            <div className="row">
                                <div className="col-lg-10 m-auto">
                                    <div className="error-page-content text-center section-space--ptb_90">
                                        ...
                                        <p className="description">It seems we can't find what you're looking for. Perhaps searching can help or go back to 
                                        {/* <a href="index-2.html">Homepage</a> */}
                                        <NavLink exact to={"/"}>Homepage</NavLink>
                                        </p>
                                        <div className="search-page-box mt-40">
                                            <form action="#" className="pages-search">
                                                <input className="input-box" type="text" placeholder="Search …" />
                                                <button className="submit-btn"><i className="icon-magnifier" /></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
