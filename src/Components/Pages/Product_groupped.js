...
function Product_groupped(props) {
    return (
        <div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div className="product-details-content">
                                            ...
                                            <table className="groupped-table">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr className="single-groupped-item">
                                                        <th>
                                                            <div className="product-groupped-item">
                                                                <a className="product-title" href="#">Black teapot</a>
                                                                <span className="price">£&nbsp;40.00</span>
                                                            </div>
                                                        </th>
                                                        <th>
                                                            <div className="quickview-quality">
                                                                <input type="number" className="input-text" defaultValue={0} />
                                                            </div>
                                                        </th>
                                                    </tr>
                                                    <tr className="single-groupped-item">
                                                        <th>
                                                            <div className="product-groupped-item">
                                                                <a className="product-title" href="#">Teapot with black tea</a>
                                                                <span className="price">£&nbsp;635.00</span>
                                                            </div>
                                                        </th>
                                                        <th>
                                                            <div className="quickview-quality">
                                            ...
                                            <div className="quickview-action-wrap mt-30">
                                                <div className="quickview-cart-box">
                                                    <div className="quickview-button">
                                                        <div className="quickview-cart w-100  button ml-0">
                                                            <a href="product-details.html" className="btn--lg w-100 text-center btn--black font-weight--reguler text-white">Add to cart</a>
                                                        </div>
                                        ...
                                        <div className="col-lg-12">
                                            ...
                                            <div className="single-product-item text-center">
                                                <div className="products-images">
                                                    ...
                                                    <NavLink exact to={"/product_detail"}><img src="assets/images/product/1_1-300x300.webp" className="img-fluid" alt="Product Images" width={300} height={300} /></NavLink>
            ...
            {/*====================  End of scroll top  ====================*/}</div>

    );
}

export default Product_groupped;