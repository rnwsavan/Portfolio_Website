...
import React_Slider from '../../Container/Slider/React_Slider';
        ...
        <div>
            <div id="main-wrapper">
                <div className="site-wrapper-reveal">
                    ...
                    <div className="hero-area hero-slider-10">
                    ...
                    <div className="newsletter-wrap section-space--pt_90">
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="section-title small-mb__40 tablet-mb__40">
                                        <h2 className="mb-30">Sign Up To Get 50% Discount</h2>
                                        <p>Subscribe to our newsletter and get a 50% discount.The joy of our customersis a great honor for us.</p>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="newsletter-wrap">
                                        <form action="#" className="newsletter--four">
                    ...
                    {/* Arival Product Area Start */}
                    <div className="arival-product-area section-space--ptb_90">
                        <div className="container-fluid container-fluid--cp-100">
                            <div className="row">
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-product--03">
                                        <a href="#"><img src="assets/images/banners/pr5-600x429.webp" width={600} height={429} className="img-fluid" alt="Images" /></a>
                                        <div className="product-content">
                                            <h2 className="mb-30"><a href="#">Drinking Glasses</a></h2>
                                            <div className="product-details">
                                                <p>Various versions have evolved over the years, some <br />  times by accident, some times on purpose.</p>
                                            </div>
                                            <div className="button-box section-space--mt_60">
                                                <a href="#" className="text-btn-normal font-weight--reguler font-lg-p" tabIndex={0}>Shop Now <i className="icon-arrow-right" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-product--03 d-item mt-130">
                                        <div className="product-content top--content order-md-1 order-2">
                                            <h2 className="mb-30"><a href="#">Hanna Chair</a></h2>
                                            <div className="product-details">
                                                <p>Various versions have evolved over the years, some <br />  times by accident, some times on purpose.</p>
                                            </div>
                                            <div className="button-box section-space--mt_60">
                                        ...
                                        <a href="#" className=" order-md-2 order-1"><img src="assets/images/banners/pr6-570x570.webp" width={570} height={570} className="img-fluid" alt="Images" /></a>
                                    </div>
                                </div>
                                <div className="col-lg-4  col-md-6 ms-auto">
                                    <div className="single-product--03 small-mt__60">
                                        <a href="#"><img src="assets/images/banners/pr7.webp" width={400} height={450} className="img-fluid" alt="Images" /></a>
                                        <div className="product-content top--content">
                                            <h2 className="mb-30"><a href="#">Wooden Cups</a></h2>
                                            <div className="product-details">
                                                <p>Various versions have evolved over the years, some <br />  times by accident, some times on purpose.</p>
                                            </div>
                                            <div className="button-box section-space--mt_60">
                                ...
                                <div className="col-lg-6 col-md-6 mt-180">
                                    <div className="single-product--03">
                                        <a href="#"><img src="assets/images/banners/pr8.webp" width={655} height={500} className="img-fluid" alt="Images" /></a>
                                        <div className="product-content top--content">
                                            <h2 className="mb-30"><a href="#">Table Black</a></h2>
                                            <div className="product-details">
                                                <p>Various versions have evolved over the years, some <br />  times by accident, some times on purpose.</p>
                                            </div>
                                            <div className="button-box section-space--mt_60">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-product--03 small-mt__60">
                                        <a href="#"><img src="assets/images/banners/pr10-600x600.webp" wedth={600} height={600} className="img-fluid" alt="Images" /></a>
                                        <div className="product-content top--content">
                                            <h2 className="mb-30"><a href="#">Table Black</a></h2>
                                            <div className="product-details">
                                                <p>Various versions have evolved over the years, some <br />  times by accident, some times on purpose.</p>
                                ...
                                <div className="col-lg-4 col-md-6 ms-auto mt-180">
                                    <div className="single-product--03">
                                        <a href="#"><img src="assets/images/banners/pr9-405x405.webp" width={405} height={405} className="img-fluid" alt="Images" /></a>
                                        <div className="product-content top--content">
                                            <h2 className="mb-30"><a href="#">Table Black</a></h2>
                                            <div className="product-details">
                                                <p>Various versions have evolved over the years, some <br />  times by accident, some times on purpose.</p>
                        ...
                        <div className="container-fluid container-fluid--cp-100">
                            <div className="row footer-widget-wrapper">
                                <div className="col-lg-3 col-md-4 col-sm-6 footer-widget">
                                    <h6 className="footer-widget__title mb-20">Customer Service</h6>
                                ...
                                <div className="col-lg-2 offset-lg-1 col-md-4 col-sm-6 footer-widget">
                                    <h6 className="footer-widget__title mb-20">Quick Link</h6>
                                    <ul className="footer-widget__list">
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 footer-widget">
                                    <h6 className="footer-widget__title mb-20">Instagram</h6>
                        ...
                        <div className="container-fluid container-fluid--cp-100">
                            <div className="row align-items-center">
                                <div className="col-lg-6 col-md-6 order-md-1 order-2">
                                    <span className="copyright-text text-center text-md-start">© 2022 Helendo. <a href="https://hasthemes.com/" target="_blank">All Rights Reserved.</a></span>
                                </div>
