        ...
        <div>
            ...
            <div id="main-wrapper">
                <div className="site-wrapper-reveal border-bottom">
                    ...
                    <div className="blog-page-wrapper section-space--pt_90 section-space--pb_120">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    {/* Single Blog Item Start */}
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/8-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Interior design is the art, the interior designer is the artist.</a></h6>
                                ...
                                <div className="col-lg-4 col-md-6  col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/9-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Decorate your home with the most modern furnishings.</a></h6>
                                            <div className="meta-tag-box">
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/10-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Spatialize with the decorations of the Helendo store.</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 18, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/1-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Unique products that will impress your home in 2022.</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 15, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6  col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/2-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog_grid"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Intelligent, award-winning product of the designer Thomas in 2022.</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 13, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/3-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Interior designer Nancy, the witch of the unique space.</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 18, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/6-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Design your home to your ideas.</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 23, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-4 col-md-6  col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        <div className="blog-thumbnail-box">
                                            <a href="#" className="thumbnail">
                                                <img src="assets/images/blog/7-570x370.webp" className="img-fluid" alt="Blog Images" />
                                            </a>
                                            {/* <a href="#" className="btn-blog"> Read more </a> */}
                                            <NavLink exact to={"/blog_grid"} className="btn-blog"> Read more</NavLink>
                                        </div>
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">The story of Helen Do’s lights in USA</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 02, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                ...
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div className="single-blog-item mt-40">
                                        ...
                                        <div className="blog-contents">
                                            <h6 className="blog-title"><a href="#">Top 10 unique deco products 2018</a></h6>
                                            <div className="meta-tag-box">
                                                <div className="meta date"><span>October 17, 2022</span></div>
                                                <div className="meta author"><span><a href="#">Hastheme</a></span></div>
                                                <div className="meta cat"><span>in <a href="#">Chair</a></span></div>
                                            </div>
                                        </div>
