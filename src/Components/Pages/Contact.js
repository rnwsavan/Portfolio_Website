                    ...
                    <div className="site-wrapper-reveal border-bottom">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-7">
                                                    <div className="contact-form-wrap  section-space--mt_60">
                                                        ...
                                                        <form id="contact-form" className="mt-30" action="https://hasthemes.com/file/mail.php" method="post">
                                                            <div className="contact-form">
                                                                ...
                                                                <div className="submit-btn mt-20">
                                                                    <button className="btn btn--black btn--md" type="submit">Submit</button>
                                                ...
                                                <div className="col-lg-4 ms-auto">
                                                    <div className="conatact-info-text section-space--mt_60">
                                                        ...
                                                        <p className="mt-30">1102 Helen Estates, Guys Store, San Diego, USA. <br />(693) 650-2389 <br />office@helentheme.com</p>
                        ...
                        <div className="map-area">
                            <div className="google-map">
                                <div id="googleMap-1" className="embed-responsive-item googleMap-1" data-lat="40.730610" data-long="-73.935242" />
                            </div>
                        </div>
                    </div>
                    {/*====================  footer area ====================*/}
