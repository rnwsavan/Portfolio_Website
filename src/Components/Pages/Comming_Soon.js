                            ...
                            <div className="row breadcrumb_box  align-items-center">
                                ...
                                <div className="col-lg-6  col-md-6 col-sm-6">
                                    ...
                                    <ul className="breadcrumb-list text-center text-sm-end">
                                        ...
                                        <li className="breadcrumb-item active">Coming Soon</li>
                                    </ul>
                                    {/* breadcrumb-list end */}
                                </div>
                            </div>
            ...
            <main>
                <div id="main-wrapper">
                    <div className="site-wrapper-reveal border-bottom">
                        <div className="coming-soon-area section-space--ptb_120">
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="coming-soon-content">
                                            <h1 className="mb-20">Coming Soon...</h1>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t slightly believable.</p>
                                            <h6 className="mb-30 section-space--mt_60">NEW STORE WE BE LUNCHED IN:</h6>
                                            {/* countdown start */}
                                            <div className="countdown-deals counter-style--three" data-countdown="2024/12/01">
                                            <div class="countdown-deals counter-style--three" data-countdown="2024/12/01"><div class="single-countdown"><span class="single-countdown__time">842</span><span class="single-countdown__text">Days</span></div><div class="single-countdown"><span class="single-countdown__time">06</span><span class="single-countdown__text">Hours</span></div><div class="single-countdown"><span class="single-countdown__time">46</span><span class="single-countdown__text">Mints</span></div><div class="single-countdown"><span class="single-countdown__time">11</span><span class="single-countdown__text">Secs</span></div></div>
                                            </div>
                                            {/* countdown end */}
